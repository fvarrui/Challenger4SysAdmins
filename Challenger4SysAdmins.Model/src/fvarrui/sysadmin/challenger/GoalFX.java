...
import fvarrui.sysadmin.challenger.test.TestFX;
...
public class GoalFX {
	...
	private ObjectProperty<TestFX> test;
	...
	public GoalFX(String name) {
		this(name, null);
	}
	
	public GoalFX(String name, String description) {
		super();
	...
	public final ObjectProperty<TestFX> testProperty() {
		return this.test;
	}
	
	@XmlElement
	public final TestFX getTest() {
		return this.testProperty().get();
	}
	

	public final void setTest(final TestFX test) {
